...
/**
 * Standard AGENTS.md template for workspace projects managed by AgenticSDLC.
 * Establishes default operational directives, coding guidelines, plan-first rules, and testing standards.
 */
public class DefaultAgentsMdTemplate {

    public static String getTemplateContent(String projectName, LanguageStack languageStack, ProjectType projectType) {
        return String.format("""
                ...
                """, projectName, languageStack, projectType);
    }
}
